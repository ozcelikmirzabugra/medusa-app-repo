...
function buildPriceSetPricesForCore(prices) {
    return prices.map(function (price) {
        var _a;
        var productVariant = price.price_set.variant;
        var rules = price.price_rules
            ? buildPriceSetRules(price.price_rules)
            : {};
        return __assign(__assign({}, price), { variant_id: (_a = productVariant === null || productVariant === void 0 ? void 0 : productVariant.id) !== null && _a !== void 0 ? _a : null, rules: rules });
    });
}
