...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var authModuleService, input, result, jwt_secret, authUser, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                authModuleService = req.scope.resolve(modules_sdk_1.ModuleRegistrationName.AUTH);
            ...
            case 1:
                ...
                return [4 /*yield*/, authModuleService.retrieve(req.auth.auth_user_id)];
            case 2:
                authUser = _a.sent();
