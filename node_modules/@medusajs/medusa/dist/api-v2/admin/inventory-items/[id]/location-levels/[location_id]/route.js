...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, inventory_item_id, location_id, remoteQuery, errors, _b, inventory_item;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = req.params, inventory_item_id = _a.id, location_id = _a.location_id;
                remoteQuery = req.scope.resolve(utils_1.ContainerRegistrationKeys.REMOTE_QUERY);
                return [4 /*yield*/, (0, core_flows_2.updateInventoryLevelsWorkflow)(req.scope).run({
                        input: {
                            updates: [__assign({ inventory_item_id: inventory_item_id, location_id: location_id }, req.validatedBody)],
                        },
                        throwOnError: false,
                    })];
            case 1:
            ...
            case 2:
                _b = __read.apply(void 0, [_c.sent(), 1]), inventory_item = _b[0];
                res.status(200).json({
