...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, remoteQuery, _a, stock_location;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = __read.apply(void 0, [_b.sent(), 1]), stock_location = _a[0];
                if (!stock_location) {
                    throw new utils_2.MedusaError(utils_2.MedusaError.Types.NOT_FOUND, "Stock location with id: ".concat(id, " was not found"));
                }
                res.status(200).json({ stock_location: stock_location });
                return [2 /*return*/];
        }
    });
}); };
