...
exports.adminStockLocationRoutesMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/stock-locations",
        middlewares: [
            (0, middlewares_1.transformBody)(validators_1.AdminPostStockLocationsReq),
            (0, middlewares_1.transformQuery)(validators_1.AdminPostStockLocationsParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
        ...
        middlewares: [
            (0, middlewares_1.transformQuery)(validators_1.AdminGetStockLocationsLocationParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
];
