...
exports.refetchProduct = exports.remapVariant = exports.remapProduct = exports.remapKeysForVariant = exports.remapKeysForProduct = void 0;
...
var remapVariant = function (v) {
    var _a, _b;
    return __assign(__assign({}, v), { prices: (_b = (_a = v.price_set) === null || _a === void 0 ? void 0 : _a.prices) === null || _b === void 0 ? void 0 : _b.map(function (price) { return (__assign(__assign({}, price), { variant_id: v.id })); }), price_set: undefined });
};
...
var refetchProduct = function (productId, scope, fields) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                remoteQuery = scope.resolve("remoteQuery");
