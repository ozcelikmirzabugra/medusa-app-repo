...
var createV2User = function (_a, _b) {
    var email = _a.email, password = _a.password;
    var container = _b.container;
    return __awaiter(void 0, void 0, void 0, function () {
        var authService, userService, user, authUser;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, userService.create({ email: email })];
                case 1:
                    user = _c.sent();
                    return [4 /*yield*/, authService.authenticate("emailpass", {
                            body: {
                                email: email,
                                password: password,
                            },
...
function default_1(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var app, container, inviteService, invite_1, configModule, featureFlagRouter, userService, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    ...
                    if (!featureFlagRouter.isFeatureEnabled(utils_1.MedusaV2Flag.key)) return [3 /*break*/, 7];
                    return [4 /*yield*/, createV2User({ email: email, password: password }, { container: container })];
                case 6:
                    _b.sent();
                    return [3 /*break*/, 9];
                case 7:
